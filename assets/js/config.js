...
DIGIT.nav = [
  ...
  },
  {
    ...
    items: [
      { id: 'color',      label: 'Color Palette', path: 'docs/foundation/color.html#color-palette' },
      { id: 'spacing',    label: 'Spacing',    path: 'docs/foundation/spacing.html#spacing' },
      { id: 'typography', label: 'Typography', path: 'docs/foundation/typography.html#typography' },
      { id: 'icon',       label: 'Icon',       path: 'docs/foundation/icon.html#icon' },
      { id: 'radius',     label: 'Radius',     path: 'docs/foundation/radius.html#radius' },
    ],
  },
  {
    id: 'components',
    ...
    items: [
      { id: 'atoms',     label: 'Atoms',     path: 'docs/components/atoms.html#atoms',         badge: '20+' },
      { id: 'molecules', label: 'Molecules',  path: 'docs/components/molecules.html#molecules',  badge: '17+' },
    ],
  },
  {
    id: 'patterns',
    ...
    items: [
      { id: 'form',    label: 'Form',    path: 'docs/patterns/form.html#form' },
      { id: 'inbox',   label: 'Inbox',   path: 'docs/patterns/inbox.html#inbox' },
      { id: 'summary', label: 'Summary', path: 'docs/patterns/summary.html#summary' },
    ],
  },
];
